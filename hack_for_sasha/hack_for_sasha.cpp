...
{   
    if (is_acces && key == -1)
        printf ("Access granted! (Childhood vulnerability)\n");
    
    else if (is_acces && key == 0)
        printf ("It was the easiest one! Good luck looking for other vulnerabilities\n");

    else if (is_acces && key == 1)
        printf ("Congrats! You solved the medium-hard vulnerability!\n");

    else if (is_acces && key == 2)
        printf ("You're genious! You solved the hardest vulnerability!\n");
